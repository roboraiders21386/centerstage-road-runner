...
public class DrawRectangleProcessor implements VisionProcessor {
    ...
    public Rect rect = new Rect(145, 168, 40, 60);
    Selected selection = Selected.NOT_PRESENT;
    ...
    public void onDrawFrame(Canvas canvas, int onscreenWidth, int onscreenHeight,
        ...
        canvas.drawRect(makeGraphicsRect(rect, scaleBmpPxToCanvasPx), selectedPaint);
/*
...
// Here Selected can be NOT_PRESENT or PRESENT based on if pixel is detected or not

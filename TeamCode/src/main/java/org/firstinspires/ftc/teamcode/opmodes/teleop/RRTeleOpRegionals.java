...
@TeleOp(name = "RR TeleOp - Regionals (Double Claw)", group = "00-Teleop")
public class RRTeleOpRegionals extends LinearOpMode {

    //private TouchSensor pixel;

    private Servo intake; //Intake/Claw AXON Servo
    private Servo innerIntake;
    private Servo wrist;
    private Servo drone;
    ...
    //RELEASE -> OPEN
    //GRAB -> CLOSE
    final double CLAW_RELEASE = 0.5;
    final double CLAW_GRAB = 0.3;
    ...
    public void runOpMode() throws InterruptedException {
        ...
        innerIntake = hardwareMap.get(Servo.class, "INNER INTAKE");
...
/*
            ...
            if (gamepad1.x && !gamepad1.back && wristServoTimer.milliseconds() > SERVOWAIT) {
                wrist.setDirection(Servo.Direction.REVERSE);
                wristServoTimer.reset();
                targetServoPosition = TURN_WRIST - SERVOINC;
                telemetry.addData("Turn", "Over");
                telemetry.update();
            }
